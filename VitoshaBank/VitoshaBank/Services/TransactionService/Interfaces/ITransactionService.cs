...
namespace VitoshaBank.Services.TransactionService.Interfaces
{
    public interface ITransactionService
    {
        ...
        public  Task<ActionResult> CreateTransaction(Users user, ClaimsPrincipal currentUser, decimal amount, Transactions transaction, string reason, BankSystemContext _context, MessageModel _messageModel);
    }
}
