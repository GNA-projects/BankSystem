...
namespace VitoshaBank.Services.Interfaces.WalletService
{
    public interface IWalletsService
    {
        ...
        public Task<ActionResult<MessageModel>> SimulatePurchase(Wallets wallet, string product, string reciever, ClaimsPrincipal currentUser, string username, decimal amount, BankSystemContext _context, ITransactionService _transation, MessageModel _messageModel);
