...
namespace VitoshaBank.Services.Interfaces.WalletService
{
    public interface IWalletsService
    {
        ...
        public Task<ActionResult<MessageModel>> CreateWallet(ClaimsPrincipal currentUser, string username, Wallets wallet, IIBANGeneratorService _IBAN, IBCryptPasswordHasherService _BCrypt, IConfiguration _config, BankSystemContext _context, MessageModel _messageModel);
