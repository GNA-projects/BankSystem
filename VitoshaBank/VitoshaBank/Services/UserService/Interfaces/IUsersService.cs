...
namespace VitoshaBank.Services.Interfaces.UserService
{
    public interface IUsersService
    {
        ...
        public Task<ActionResult<MessageModel>> CreateUser(ClaimsPrincipal currentUser, Users user, IBCryptPasswordHasherService _BCrypt, IConfiguration _config, BankSystemContext _context, MessageModel messageModel);
