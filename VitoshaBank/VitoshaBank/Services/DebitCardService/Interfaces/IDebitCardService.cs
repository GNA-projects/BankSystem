...
namespace VitoshaBank.Services.DebitCardService.Interfaces
{
    public interface IDebitCardService
    {
        ...
        public Task<ActionResult<MessageModel>> CreateDebitCard(ClaimsPrincipal currentUser, string username, ChargeAccounts bankAccount, BankSystemContext _context, Cards card, IBCryptPasswordHasherService _BCrypt, MessageModel _messageModel);
